...
class OwnershipHistory(models.Model):
    ...
    from_owner = models.ForeignKey(Owner, related_name='transfers_from', on_delete=models.SET_NULL, null=True, blank=True)
    to_owner = models.ForeignKey(Owner, related_name='transfers_to', on_delete=models.SET_NULL, null=True, blank=True)
